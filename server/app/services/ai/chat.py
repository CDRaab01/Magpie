...
_SYSTEM = (
    ...
    "- Be descriptive, not advisory: report what the numbers say. Give no investment, tax, "
    "budgeting, or legal advice, and never tell the household what they should do with their money.\n"
